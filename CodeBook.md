...
This file contains 68 varialbes add 180 observations. The first 2 variables, Subject and Activity represent person and activities respectively and the rest of the variables represents the summary, either mean or standard deviation, of the features of the mean or deviation that were originally measured from the accelerometers from Samsung Galaxy S smartphone on the wrist for all combinations of Subjects and Activities.  

The measurements were collected from 30 group of people with age between 19 and 48 years old and 6 activiies, therefore 30 x 6 = 180 observations. The original data set contains 7352 training data and 2947 test data for 561 measurements, which was obtained from the following URL: 
...
* f: Fast Fourier Transform (FFT) (prefix 'f' to indicate frequency domain signals)
